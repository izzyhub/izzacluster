...
1. Output all the common resources in your cluster.
   ...
   📍 _Feel free to use the provided [kubernetes tasks](.taskfiles/Kubernetes.yaml) for validation of cluster resources or continue to get familiar with the `kubectl` and `flux` CLI tools._
